...
namespace BT2MWG.Controllers
{
    public class DataHelper
    {
        public List<Product> initProducts()
        {
            ...
            listProduct.Add(new Product { ProductID = 1, Name = "Đồ chơi trạm cảnh sát tuần tra và cứu hỏa biển Lego City 60308 (297 chi tiết)", Image = Image1, Price = 1399000, Discount = 20, Promotion = Promotions1, Brand = "Lego (Đan Mạch)", Kind = Kinds1, AgeLimit = "Từ 5 tuổi trở lên", Material = "Nhựa", Size = "38x26x6", Weight = 724, Warn = "Có các chi tiết nhỏ, không dùng cho trẻ dưới 3 tuổi, tránh nguy cơ tiềm ẩn khi trẻ sử dụng sai", Origin = "Trung Quốc" });
            listProduct.Add(new Product { ProductID = 2, Name = "Đồ chơi xe địa hình cứu hộ Lego City 60301 (157 chi tiết)", Image = Image2, Price = 993200, Discount = 13, Promotion = Promotions2, Brand = "Lego (Đan Mạch)", Kind = Kinds2, AgeLimit = "Từ 5 tuổi trở lên", Material = "Nhựa", Size = "38x26x6", Weight = 724, Warn = "Có các chi tiết nhỏ, không dùng cho trẻ dưới 3 tuổi, tránh nguy cơ tiềm ẩn khi trẻ sử dụng sai", Origin = "Trung Quốc" });
            return listProduct;
        }
    }
}
